...
Route::get('/forbidden', function () {
    return view('siswa/tayo');
});

Route::get('/soal-siswa/forbidden', function () {
    return view('siswa/cepmek');
});

Route::get('/bebasadmin', function () {
    return view('siswa/bebas_admin');
});
...
Route::get('/iuran-siswa', 'GuruController@iuran_siswa');
Route::post('/ubah-status-siswa', 'GuruController@ubahStatusSiswa');
Route::get('/bypass-toggle', 'GuruController@bypass_toggle');
...
Route::post('/duplicateformsoal', 'SoalController@duplicateformsoal');
...
//mezt update duplikat soal 9Des18
Route::get('duplicate-soal/{id}', 'SoalController@duplicatesoal');
